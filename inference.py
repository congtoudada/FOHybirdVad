...
def evaluate_model(predictions, labels, videos,
                   range=302, mu=21, normalize_scores=False, draw_vis=False):
    aucs = []
    filtered_preds = []
    filtered_labels = []
    ...
    print(f"MicroAUC: {micro_auc}, MacroAUC: {macro_auc} range={range}, mu={mu}, normalize_scores={normalize_scores}")
